...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⩹⌯⊷━♢ ⦓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」 ♢━⊶⌯⩺**\n[𝙎𝙋𝙄𝘿𝞝𝙍 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/UI_VM)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**WWWL5"):
            ...
            result = builder.article(
                title="WWWL5 Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب سبايدر **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/EE_20"),
                Button.url(
                    "المطور",
                    "t.me/WWWL5",
                ),
